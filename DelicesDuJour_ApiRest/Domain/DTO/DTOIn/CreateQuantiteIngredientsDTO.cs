...
namespace DelicesDuJour_ApiRest.Domain.DTO.DTOIn
{
    ...
    /// <summary>
    /// Définit les règles de validation pour la classe <see cref="CreateQuantiteIngredientsDTO"/>.
    /// </summary>
    public class CreateRecetteIngredientRelationshipDTOValidator : AbstractValidator<CreateQuantiteIngredientsDTO>
    {
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="CreateRecetteIngredientRelationshipDTOValidator"/> et configure les règles de validation.
        /// </summary>
